...
Usage:
    python scripts/plan_captures.py data/processed/demos/furia-vs-vitality-m1-mirage
    python scripts/plan_captures.py data/processed/demos/  --all
    python scripts/plan_captures.py data/processed/demos/furia-vs-vitality-m1-mirage --dry-run
"""
...
def main():
    ...
    if args.all and input_path.is_dir():
        ...
        # Strip any suffix the user might have included
