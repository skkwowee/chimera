...
| 5 | **Fix `build_tick_sequences.py:918`** — derive `tickrate_hz` from 64/downsample, not hardcoded 8 (plus the line-846 print) | Minutes | Any future 16Hz bake would stamp false provenance |
...
| 12 | **Record negative-source rationales in the datasheet**: PureSkill csds (parser-provenance confound), ESTA/CS:GO-era (wrong game/parser/schema) | 15 min | Stops future "time-saving" shortcuts |
