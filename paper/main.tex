...
% Base model: Qwen3.5-27B (dense, 4-bit NF4 quantized via BitsAndBytes).
% Training: QLoRA via peft (LoRA rank r=16-64 on 4-bit base). Both SFT and GRPO train only LoRA adapters
