...
% Base model: Qwen3.5-35B-A3B (MoE, 35B total / 3B active per token) in bf16 on H200 SXM (141 GB).
% MoE gives ~9x faster inference than 27B dense — critical for GRPO with G=16 completions per prompt (D022).
